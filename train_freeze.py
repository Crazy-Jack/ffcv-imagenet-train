...
class ImageNetTrainer:
    ...
    def create_optimizer(self, momentum, optimizer, weight_decay,
        ...
        all_params = list(self.model.module.fc.named_parameters())
        ...
        for ix, (images, target) in enumerate(iterator):
            ...
            with autocast():
                ...
                with torch.no_grad():
                    ...
                    x = self.model.module.net(images)
                    p3, p4, p5 = x
                    feature = self.model.module.adaptive_avg_pool(p5).squeeze(-1).squeeze(-1)
                output = self.model.module.fc(feature)
