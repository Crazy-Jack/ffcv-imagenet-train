...
class ImageNetTrainer:
    ...
    def create_train_loader(self, train_dataset, num_workers, batch_size,
        ...
        self.decoder2 = RandomResizedCropRGBImageDecoder((res, res))
    ...
    def train_loop(self, epoch, log_level, l1_sparsity_lamda):
        ...
        for ix, loaders in enumerate(iterator):

            images_0 = loaders[0]
            target = loaders[1]
            batch_size = loaders[1].size(0)
            images_1 = loaders[2]
            images = ch.cat((images_0, images_1), dim=0)
